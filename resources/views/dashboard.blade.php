...
<div class="container mx-auto">
        ...
        <div class="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
            <div class="md:col-span-2 lg:col-span-1" >
                ...
                <div class="h-full py-8 px-6 space-y-6 rounded-xl border border-gray-200 bg-white">
                    ...
                    <div>
                        <h5 class="text-xl text-gray-600 text-center">Company Details</h5>
                        <span class="block text-center text-gray-500">Company Report for last week</span>
                    </div>
            ...
            <div> 
                ...
                <div class="lg:h-full py-8 px-6 text-gray-600 rounded-xl border border-gray-200 bg-white">
                    ...
                    <div class="mt-6">
                        <h5 class="text-xl text-gray-700 text-center">Edit User Profile</h5>
    ...
    <div class="flex items-center justify-end mt-4">
        ...
        <a href="{{ route('company') }}" class="ml-4 inline-flex items-center px-4 py-2 bg-gray-800 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-gray-700 active:bg-gray-900 focus:outline-none focus:border-gray-900 focus:ring ring-gray-300 disabled:opacity-25 transition ease-in-out duration-150">
            {{ __('Add Company') }}
        </a>
    </div>
